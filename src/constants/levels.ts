...
export const LEVELS: LevelData[] = [
  {
    ...
    requiredScore: 3,
    platforms: [
      { id: 'p1', x: 0, y: 80, width: 15, height: 20, type: 'static' },
      { id: 'p2', x: 18, y: 70, width: 10, height: 20, type: 'static' },
      { id: 'p3', x: 32, y: 60, width: 10, height: 20, type: 'static' },
      { id: 'p4', x: 48, y: 50, width: 10, height: 20, type: 'bouncy' },
      { id: 'p5', x: 65, y: 65, width: 10, height: 20, type: 'vanishing' },
      { id: 'p6', x: 82, y: 55, width: 15, height: 20, type: 'static' },
    ],
    obstacles: [
      { id: 'o1', type: 'spike', x: 15, width: 3, height: 5 },
      { id: 'o2', type: 'spike', x: 28, width: 4, height: 5 },
      { id: 'o3', type: 'spike', x: 42, width: 4, height: 5 },
      { id: 'o4', type: 'spike', x: 60, width: 5, height: 5 },
      { id: 'o5', type: 'spike', x: 75, width: 5, height: 5 },
      { id: 'o6', type: 'lava', x: 0, width: 100, height: 4 },
      { id: 'o7', type: 'moving_wall', x: 40, width: 4, height: 30, speed: 1, direction: 'horizontal' },
    ],
  },
  {
    id: 2,
